...
### Documentation
- [ ] Update `contracts/service-groups/pulse-backend/services/gapi-api/api.md` with new endpoint
- [ ] Update `contracts/service-groups/pulse-backend/services/pulse-api/api.md` if needed
- [ ] Update `contracts/schemas/common.md` with new schemas
